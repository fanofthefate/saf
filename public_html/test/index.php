...
<meta property="og:image:height" content="300" />
	...
	*/?> 
	...
	<link href="<?=SITE_TEMPLATE_PATH?>/css/style14.css?v=<?=RAND(0,100)?>" type="text/css"  rel="stylesheet" />
		...
		<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KWZMMDP"
			...
			<section id="content_body">
			 ...
			 <div class="present_wrapper">
                <div class="present"><?$APPLICATION->IncludeFile("/include/txt_info.php", Array("CODE"=>"k_button_present"), Array("MODE"=>"php"));?>Новогодний подарок можно приобрести вместе с билетом</div>
            </div>
		</div>		
	</header>
...
<!-- 	<script>
	...
	<section class="bike">
		...
		<div class="mid mid_small">
			...
			<div class="timer">				
				<?
				?>
				<div class="timer__head">До финального концерта осталось:</div>
    ...
    <section class="points">
        <div class="mid mid_small">
            <h3 class="ttl text_shadow">ОФИЦИАЛЬНАЯ КАССА</h3>
...
<script src="<?=SITE_TEMPLATE_PATH?>/js/init.js?v=4.4"></script>
