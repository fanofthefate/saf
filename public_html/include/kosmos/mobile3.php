...
<meta property="og:image" content="<?=SITE_TEMPLATE_PATH?>/mobile/img/Fotonka.jpg">
	...
	*/?>
	...
	<link href="<?=SITE_TEMPLATE_PATH?>/css/style13.css?v=1.1" type="text/css"  rel="stylesheet" />
		...
		<div class="foot__con">
			<div class="foot__l">
				...
				<div class="social_bot">
					<a target="_blank" href="https://api.whatsapp.com/send?phone=79851150221&text=Здравствуйте, вопрос по шоу 'Тайна трех планет'"><img src="<?=SITE_TEMPLATE_PATH?>/img/whatsapp.svg" alt="WhatsApp"></a>
