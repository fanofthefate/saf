...
<meta property="og:image" content="<?=SITE_TEMPLATE_PATH?>/mobile/img/Fotonka.jpg">
	...
	*/?>
	...
	<link href="<?=SITE_TEMPLATE_PATH?>/css/style14.css?v=1.1" type="text/css"  rel="stylesheet" />
	<link rel="stylesheet" media="all and (orientation:landscape)" href="<?=SITE_TEMPLATE_PATH?>/css/landscape.css">
...
<section class="hand">
	...
	<div class="hand__box">
		...
		<div class="head__age hand__age">3+</div>
		<div class="mid">
...
<section class="bike">
	<div class="mid mid_small">
		...
		<div class="bike__foot">
			<div class="sell sell_col cf">
				<a  href="<?$APPLICATION->IncludeFile("/include/txt_info.php", Array("CODE"=>"k_button2","MOBILE"=>"Y"), Array("MODE"=>"php"));?>" class="sell__button sell__button_big"><img src="<?=SITE_TEMPLATE_PATH?>/mobile/img/sell2_2.png" alt=""></a>
			</div>
			<div class="rate cf">
				<div class="rate__left">
					<span class="rate__text">Осталось билетов в продаже:</span>
...
<section class="points">
        <div class="mid mid_small">
            <h3 class="ttl">ОФИЦИАЛЬНАЯ КАССА</h3>
			<?
...
<!-- Здесь мессенджеры -->
	...
	<script src="<?=SITE_TEMPLATE_PATH?>/js/init2_mobile.js?v=1.8"></script>
