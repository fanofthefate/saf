		...
		<div class="swiper-container" id="video_slider">
			...
			<div class="swiper-wrapper">
				...
				foreach($arResult["ITEMS"] as $arItem) 	
				{
					...
					foreach(array_reverse($arItem["PROPERTIES"]["VIDEOS"]["VALUE"]) as $video) {
						$pos = strpos($video,"?v=");
						$pos2 = strpos($video,"&");
						...
						$item["PREVIEW1"] = "https://img.youtube.com/vi/".$code."/mqdefault.jpg";
						$item["HREF"] = $video;
					
					
				?>
				<div class="swiper-slide">
					<a href="<?=$item["HREF"]?>" data-sub-html="<h4><?=$arItem["NAME"]?></h4>" class="video-play pop">
						<img alt="" class="swiper-lazy swiper-lazy-loaded" src="<?=$item["PREVIEW1"]?>">
					</a>
				</div>
				<?}
				}
