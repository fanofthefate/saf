		...
		<div class="swiper-wrapper">
			...
			<?
					...
					foreach($arResult["ITEMS"] as $arItem) 	
					{
						...
						$desc = $arItem["DETAIL_PICTURE"]["DESCRIPTION"];
...
//								print("4X4<br/>");
							...
							else 
							{
								...
								?>
									<div class="slide-1x1">
										<a href="<?=$imgpath?>" class="pop" data-sub-html="<h4><?=$desc?></h4>" style="background: url(<?=$renderImage232['src']?>) 100% 100% no-repeat; background-size: cover;"></a>
									</div>										
								<?
								}
