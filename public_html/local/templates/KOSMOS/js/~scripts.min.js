...
var heroArray=["../img/bro__sergh.png","../img/bro__ilyah.png","../img/bro__andrh.png"];function preCacheHeros(){$.each(heroArray,function(){(new Image).src=this})}window.onload=function(){preCacheHeros(),$(function(){$(".prime__item_1").hover(function(){$(".prime__pic_1").toggleClass("active")}),$(".prime__item_2").hover(function(){$(".prime__pic_2").toggleClass("active")}),$(".prime__item_3").hover(function(){$(".prime__pic_3").toggleClass("active")}),$(".prime__item_4").hover(function(){$(".prime__pic_4").toggleClass("active")}),$(".prime__item_5").hover(function(){$(".prime__pic_5").toggleClass("active")}),$(".prime__item_6").hover(function(){$(".prime__pic_6").toggleClass("active")})}),$(".link-buy").mouseover(function(){$(this).attr("src","../img/Buttons_012.png")}),$(".link-buy").mouseout(function(){$(this).attr("src","../img/Buttons_01.png")}),$(".link-prim").mouseover(function(){$(this).attr("src","../img/ButtonsPR_02.png")}),$(".link-prim").mouseout(function(){$(this).attr("src","../img/ButtonsPR_01.png")}),$(".slider").magnificPopup({delegate:".slider__link",type:"image",tLoading:"Загрузка изображения #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},image:{tError:'<a href="%url%">Изображение #%curr%</a> не может быть загружено.'}}),$(".popup-modal").magnificPopup({type:"inline",preloader:!1,modal:!1}),$(document).on("click",".popup-modal-dismiss",function(e){e.preventDefault(),$.magnificPopup.close()}),$(".hand__pops").magnificPopup({delegate:".hand__pop",type:"image",tLoading:"Загрузка изображения #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},image:{tError:'<a href="%url%">Изображение #%curr%</a> не может быть загружено.'}}),$(".slider").slick({infinite:!0,slidesToShow:8,slidesToScroll:1,autoplay:!0,autoplaySpeed:2e3,prevArrow:'<span id="prev"><svg class="icon icon-arrow"><use xlink:href="#icon-arrow"></use></svg></span>',nextArrow:'<span id="next"><svg class="icon icon-arrow"><use xlink:href="#icon-arrow"></use></svg></span>',responsive:[{breakpoint:1220,settings:{slidesToShow:7}},{breakpoint:1060,settings:{slidesToShow:6}}]});var e=$(".bike__man"),i=$(".space_ship"),o=($(".head"),$(".asteroid__item1")),r=$(".asteroid__item2"),t=$(".asteroid__item3");function n(e,i,o){var r=$("#head"),t=e.pageX-r.offset().left,n=e.pageY-r.offset().top;TweenMax.to(i,1,{x:(t-r.width()/2)/r.width()*o,y:(n-r.height()/2)/r.height()*o})}e.paroller({factor:.2,type:"foreground",direction:"horizontal"}),i.paroller({factor:-.3,type:"foreground",direction:"horizontal"}),o.paroller({factor:-.1,type:"foreground",direction:"horizontal"}),r.paroller({factor:-.15,type:"foreground",direction:"horizontal"}),t.paroller({factor:-.2,type:"foreground",direction:"horizontal"}),$("a.scrollto").click(function(){var e=$(this).attr("href"),i=$(e).offset().top;return jQuery("html:not(:animated),body:not(:animated)").animate({scrollTop:i},800),!1}),$("#head").mousemove(function(e){n(e,".cosmo__img_1",50),n(e,".cosmo__img_2",50),n(e,".cosmo__img_3",60),n(e,".head",20)}),new WOW({boxClass:"wow",animateClass:"animated",offset:0,mobile:!1,live:!0,scrollContainer:null}).init()};